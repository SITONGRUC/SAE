...
Same implementation validated in `../reproduce_fig3.ipynb`, lifted out so Figure 5 can import
it. Three details follow the authors' shipped code rather than the appendix pseudocode:
